package com.ABC.bitrade.constant;
...
public class SysConstant {
    ...
    //昨日挖币总数
    public static final String YESTERDAY_MINE_AMOUNT_FOR_abc="YESTERDAY_MINE_AMOUNT_FOR_abc";
    //昨日持币分红
     ...
     * 60亿abc累计(过期时间为15分钟)
     */
    public static final String abc_AMOUNT="abc_AMOUNT";
    public static final int abc_AMOUNT_EXPIRE_TIME=900;
