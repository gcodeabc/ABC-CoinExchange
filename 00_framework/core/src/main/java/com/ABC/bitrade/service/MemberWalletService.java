...
import com.ABC.bitrade.dao.MemberDepositDao;
import com.ABC.bitrade.dao.MemberWalletDao;
import com.ABC.bitrade.dto.MemberWalletDTO;
import com.ABC.bitrade.entity.Coin;
import com.ABC.bitrade.entity.Member;
import com.ABC.bitrade.entity.MemberDeposit;
import com.ABC.bitrade.entity.MemberTransaction;
import com.ABC.bitrade.entity.MemberWallet;
import com.ABC.bitrade.entity.Order;
import com.ABC.bitrade.entity.OtcCoin;
import com.ABC.bitrade.entity.QMember;
import com.ABC.bitrade.entity.QMemberWallet;
...
//    }
    ...
    public List<MemberWallet> geteveryabc(String coinName,int week){
        return memberWalletDao.geteveryabc(coinName,week);
    }
     ...
     * @return
     */
    public int increaseBalanceForabc(BigDecimal mineAmount,Long memberId) {
       return  memberWalletDao.increaseBalanceForabc(mineAmount,memberId);
    }
