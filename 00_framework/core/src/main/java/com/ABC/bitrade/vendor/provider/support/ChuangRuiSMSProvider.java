package com.ABC.bitrade.vendor.provider.support;


import com.alibaba.fastjson.JSONObject;
import com.ABC.bitrade.dto.SmsDTO;
import com.ABC.bitrade.service.SmsService;
...
//    }
    ...
    public MessageResult sendByOder(String mobile, String content, SmsDTO smsDTO) throws Exception {
        ...
        submit.put("content", "您好，" + StringUtils.substringBefore(content,"#") + "广告有新的订单，对方用户名为"+StringUtils.substringAfterLast(content,"#")+"，请登录系统及时处理。【ABC】");
    ...
    public MessageResult send2Method(String mobile, String content, SmsDTO smsDTO) throws Exception {
        ...
        JSONObject[] phoneSend = new JSONObject[1];
        JSONObject submit = new JSONObject();
        submit.put("content", "您的验证码为" + content + "，十分钟内有效，如非本人操作，请忽略。【ABC】");
        submit.put("phone", mobile);
