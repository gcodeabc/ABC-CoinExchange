...
import com.ABC.bitrade.exception.GeeTestException;
import com.ABC.bitrade.service.LocaleMessageSourceService;
import com.ABC.bitrade.system.GeetestLib;
...
public class GeeTestAspect {
 ...
 // "||execution(public * com.ABC.bitrade.controller.SmsController.resetPasswordCode(..))"+
    @Pointcut("execution(public * com.ABC.bitrade.controller.RegisterController.registerByEmail(..))"+
            "||execution(public * com.ABC.bitrade.controller.RegisterController.sendResetPasswordCode(..))")
    public void geeTest() {
    	
    }
    @Pointcut("execution(public * com.ABC.bitrade.controller.SmsController.sendCheckCode(..))")
