...
public class UpdatePayAspect {
    ...
    @Pointcut("execution(public * com.ABC.bitrade.controller.ApproveController.updateAli(..))"+
            "||execution(public * com.ABC.bitrade.controller.ApproveController.updateBank(..))"+
            "||execution(public * com.ABC.bitrade.controller.ApproveController.updateWechat(..))")
