    ...
    <div class="footer">
      <div class="footer_content">
        <div class="footer_left">
          ...
          <p>Copyright © 2019 - ABC.com All rights reserved.&nbsp;&nbsp;</p>
          <div class="social-list">
            <ul>
              ...
              <Tooltip content="https://weibo.com/ABC" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconweibo" />
                </li>
              </Tooltip>
              <Tooltip content="https://twitter.com/ABCGlobal" theme="dark" placement="top">
                <li>
                  <Icon type="logo-twitter" />
                </li>
              </Tooltip>
              <Tooltip content="https://medium.com/@ABC" theme="dark" placement="top">
                <li>
                  <Icon custom="i-icon iconfont iconmedium" />
                </li>
              </Tooltip>
              <Tooltip content="https://www.reddit.com/u/ABCglobal" theme="dark" placement="top">
                <li>
          ...
          <ul>
            ...
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">service@ABC.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">support@ABC.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">list@ABC.com</p>
                </div>
              </poptip>
            </li>
            <li class="wechatclick">
              <poptip width="200" trigger="hover" placement="right">
                ...
                <div slot="content">
                  <p style="text-align:center;">ceo@ABC.com</p>
                </div>
              </poptip>
            </li>
          </ul>
  ...
  watch: {
    activeNav: function() {
      switch (this.activeNav) {
        case "nav-exchange":
          window.document.title = (this.lang == "简体中文" ? "交易中心" : "Exchange") + " - ABC | 币严 | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-service":
          window.document.title = (this.lang == "简体中文" ? "公告" : "Announcement") + " - ABC | 币严 | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-about":
          window.document.title = (this.lang == "简体中文" ? "关于" : "About") + " - ABC | 币严 | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-lab":
          window.document.title = (this.lang == "简体中文" ? "创新实验室" : "Lab") + " - ABC | 币严 | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        case "nav-invite":
          window.document.title = (this.lang == "简体中文" ? "推广合伙人" : "Promotion") + " - ABC | 币严 | 全球比特币交易平台 | 全球数字货币交易平台";
          break;
        default:
