module.exports = {
    ...
    sectionPage: {
        ...
        brandTitle: "About ABC",
        brandDetail: "Honest  |  Fair  |  Enthusiasm  |  Open",
        brandDesc1: "ABC was founded by a group of early Bitcoin participants and geeks. The core members of the team are from well-known enterprises such as Google, Microsoft, Alibaba, Tencent and so on. It has deep research and development strength and rich experience in Internet product operation.",
        brandDesc2: "ABC is located in the basic service provider of block chain, dedicated to providing high-quality encrypted assets trading platform for global users, adhering to the basic principle of “DO NOT BE EVIL”, upholding honest, fair and enthusiastic service to customers, and welcoming all partners/projects that are beneficial to the fundamental interests of users with an open attitude.",
        gettingstart: "HOT | Beginner's Guide",
        officialstart: "ABC Official Customer Service",
        ...
        baseexchangetips: "How to buy and sell on ABC",
    ...
    progress: {
        already: "Have to dig",
        total: "Amount of excavable ore 6 billion abc"
    },
    service: {
        USDT: 'USDT',
        BTC: 'BTC',
    ...
    ctc: {
        ...
        desc:"Crypto assets are managed by ABC, and the acceptor provides exchange services for exchange.",
        buyin: "Buy",
        sell: "Sell",
        buyprice: "Buy Price",
        sellprice: "Sell Price",
    ...
    activity: {
        ...
        attentiontxt4: "* The right of final interpretation of this activity belongs to the official ownership of ABC.",
        ...
        submit: "Submit",
        tipsmobile: "Please use PC web（www.ABC.com）",
    ...
    invite: {
        ...
        ruleprofile1:"[Promotion Partner] is the highest proportion of online Commission return and the longest time of commission return (maximum lifetime commission). Promoters who make corresponding efforts can become real platform ‘partners’ and enjoy the dividend of growing together with ABC trading platform. Detailed rules are as follows:",
        ruleprofile2:"",
        ruleprofile3:"",
        ruleprofile4:"",
        ruletext1: "1、In order to preach the concept of digital assets and expand the scale of users, ABC launched the “Promotion Partner” program, which is effective for a long time.",
        ...
        ruletext8: "8、TOP10 or TOP100 will be awarded additional incentives by ABC from time to time.",
        ...
        ruletext11: "11、The right of final interpretation of this activity belongs to ABC.",
        ...
        thanks: "Thank you for supporting ABC！",
        ...
        pt_tips: "If you have a good idea, please send an email to promotion@ABC.com, with a reward after adoption.！",
        ...
        pt_card_rule2: "2. Free gift cards are limited to one copy per user. Free gift cards issued by the ABC government are limited to one for each user. Even if different users receive free gift cards with different exchange codes, only one can be exchanged. Custom gift cards are not subject to this restriction.",
        ...
        pt_card_rule6: "6. The right of final interpretation of free gift cards belongs to ABC.COM.",
        pt_card_day: "Days",
    ...
    uc: {
        ...
        finance: {
            ...
            trade: {
                accumulative_return: 'Mining fees have been repaid (abc) : ',
                accumulat_return: 'Mining fees should be repaid(abc) : ',
                start_end: 'Start-End',
            ...
            inviting: {
                accumulative_return: 'Inviting mining rewards has been returned and accumulated(abc) : ',
                accumulat_return: 'Invite mining awards to be returned(abc) : ',
                account_date: 'Time for receiving the capital',
                start_end: 'Start-End',
                to: 'To',
                operatetype: 'Action Type',
                ...
                invitingawards: 'Inviting mining Awards(abc)',
                refere: 'Referee',
        ...
        identity: {
            ...
            become: "Become ABC Certified Business and enjoy more transaction privileges",
    ...
    cms: {
        ...
        download: "Download",
        downloadslogan: "ABC APP - Trade everywhere."
    },
    description: {
        title1: 'Security',
        title2: '24H Service',
        ...
        aboutdesc1: "ABC.COM is a leading digital asset trading platform in the world, registered in the Cayman Islands, with a core operating team in Hong Kong. The core members of ABC.COM come from top Internet and financial companies. Most of them are deep believers in Bitcoin and block chains. We are convinced that block chains will change the traditional monopolistic financial system and build a more democratic and autonomous social structure.",
        aboutdesc2: "ABC.COM platform has a professional financial-level trading architecture, a self-developed high concurrent memory matching trading engine. The platform uses a full-cold rechargeable wallet system + multiple signatures + high-protection DDOS attack system and other trading architecture to ensure customer asset security.",
        aboutdesc3: "In order to let customers better grasp the investment opportunities, ABC.COM adopts flat management in customer service department, and establishes an extremely fast service response mechanism. The asset customer service manager is on-line 7*24H all the year round, providing customers with services such as recharge and cash of assets, and ensuring that customers complete recharge in 25 minutes.",
        aboutdesc4: "ABC.COM strictly screens high-quality projects and provides secure and stable asset hosting services. ABC.COM upholds the concept of “honesty, justice, enthusiasm and openness”, and strives to create a safe, reliable, efficient and friendly ultimate exchange for users.",
        ...
        apply: "Board Apply",
        coop: "Cooperation",
        community: "ABC Community",
        wechat: "Wechat",
        addwechat: "Add 'ABC01' as Wechat friends and then enter Wechat community",
        weibo: "Weibo",
        twitter: "Twitter",
        biyong: "Biyong",
        telegram: "Telegram",
    ...
    index: {
        ...
        abcTotal: "abc Total flux",
        abcSecond: "abc Two level market circulation",
        ...
        abcregister: "ABC account registration",
        tibi: "The time and limit of the payment of the money to the bill",
        line_plane: "Announcement on abc's on-line plan, circulation and service fee return",
        fenpeijizhi: 'A description of the ABC income distribution mechanism',
        jiangli_jihua: "Inviting the mining Award Scheme",
        friend_fanhuan: "Invite friends, earn extra fee and return"
    },
    plate: {
        title: "Platform income distribution scheme（abc Holder's equity）",
        content1: "As described in the white paper, ABC will take up 80% of the platform (after deduct Taxes and fees )The income is allocated to abc holders, and 20% of revenue is used to support R & D and operation of the platform.",
        content2: "The distribution of income takes days as a distribution cycle, and June 6, 2018 as the first distribution day. Every day after that, the total income to be distributed on the previous day will be allocated to abc holders in proportion.",
        content3: "（notice：1. the abc here only refers to the abc that has been released / circulated. See also【",
        content3_1: 'Note on the ratio of abc circulation / participation in income distribution',
    ...
    feereturn: {
        ruletitle: "Note",
        rulecontent: 'Our White Paper has a detailed explanation of Reimbursement of Transaction Fees. Overall, 51% of the platform' + 's total abc base (referred to as "community reward portion" from now on) will be reimbursed to users over time via our "Trans-Fee Mining" mechanism. However once this 51% of the total abcs has been fully released via reimbursement, the "Trans-Fee Mining" mechanism will automatically end. ',
        recordtitle: 'List',
        recordcontent: 'Everyday (UTC+8, same as below) abc will reimburse 100% of the users' + 'transaction fees incurred from the previous day in the form of abc. This will be done by using the average abc price of the previous day (this average price is calculated as total value transacted/total volume transacted). We will complete this reimbursement of transaction fees from the previous day in the form of abcs, at 11am everyday.',
        time: "Date",
        todaycharge: "Average price (ETH)",
        totalChange: 'Total (ETH)',
        returnCharge: "Trans-Fee Mining reimbursement(abc)",
        todayChargeReturn: "Incentive Program for FCoin reimbursement（abc）"
    }
}
