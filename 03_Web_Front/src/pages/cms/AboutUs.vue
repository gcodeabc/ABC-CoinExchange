    ...
    <div class="wrapper">
      ...
      <div class="content_wrapper">
        ...
        <div class="content1">
          ...
          <p>{{$t('description.service')}}：service@ABC.com</p>
          <p>{{$t('description.support')}}：support@ABC.com</p>
          <p>{{$t('description.apply')}}：apply@ABC.com</p>
          <p>{{$t('description.report')}}：ceo@ABC.com</p>
          <p>{{$t('description.coop')}}：coop@ABC.com</p>
        </div>
        <div class="content1" style="border:none;">
          <h5>{{$t('description.community')}}</h5>
          <p>{{$t('description.wechat')}}：{{$t('description.addwechat')}}</p>
          <p>{{$t('description.weibo')}}：https://weibo.com/ABC</p>
          <p>{{$t('description.twitter')}}：https://twitter.com/ABCGlobal</p>
          <p>{{$t('description.biyong')}}：https://0.plus/ABCofficial</p>
          <p>{{$t('description.telegram')}}：https://t.me/ABCofficial</p>
          <p>{{$t('description.medium')}}：https://medium.com/@ABC</p>
          <p>{{$t('description.reddit')}}：https://www.reddit.com/u/ABCglobal</p>
        </div>
      </div>
    </div>
  </div>
