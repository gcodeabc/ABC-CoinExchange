  ...
  <div class="invite">
      ...
      <div class="promotion-tools">
        ...
        <div class="tools">
          <div class="item" @click="showCardItem">
              <img src="https://ABC.oss-cn-hangzhou.aliyuncs.com/2019/promotioncard.png"></img>
          ...
          <div class="item" @click="useInviteImage">
              <img src="https://ABC.oss-cn-hangzhou.aliyuncs.com/2019/invitebg.jpg"></img>
    ...
    <Drawer :title="$t('invite.pt_title')" :closable="false" v-model="showCardModal" width="600">
      <div class="ptcard-header">
        <img class="card-img" src="https://ABC.oss-cn-hangzhou.aliyuncs.com/2019/promotioncard.png"></img>
        <div class="desc">
      ...
      <div class="ptcard-info">
        ...
        <p class="detail">{{$t('invite.pt_card_rule1')}}：promotion@ABC.com。</p>
  ...
  data() {
    ...
    return {
      ...
      myInfo: {
        ...
        extrareward: 0,
        partnerlevel: "-",
        inviteLink: "https://www.ABC.com/register?code=000000"
      },
      promotionRecordPage: {
        pageNo: 1,
        pageSize: 10
