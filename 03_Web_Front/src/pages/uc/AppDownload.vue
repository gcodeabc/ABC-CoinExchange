<template>
  <div class="login_form app-download">
    ...
    <div class="section" id="page4">
      <ul>
        <li>
          <div><img src="https://ABC.oss-cn-hangzhou.aliyuncs.com/2019/download1.png" alt=""></div>
          <p class="title">极致体验</p>
          <p>精心优化的界面显示，体验流畅的操作响应</p>
        </li>
        <li>
          <div><img src="https://ABC.oss-cn-hangzhou.aliyuncs.com/2019/download2.png" alt=""></div>
          <p class="title">币种行情</p>
          <p>支持MACD、KDJ、RSI、BOLL等多种专业指标</p>
        </li>
        <li>
          <div><img src="https://ABC.oss-cn-hangzhou.aliyuncs.com/2019/download5.png" alt=""></div>
          <p class="title">币币交易</p>
          <p>支持限价委托与市价委托两种方式</p>
        </li>
        <li>
          <div><img src="https://ABC.oss-cn-hangzhou.aliyuncs.com/2019/download3.png" alt=""></div>
          <p class="title">法币交易</p>
          <p>优质承兑商，保证资金通道顺畅无阻</p>
        </li>
        <li>
          <div><img src="https://ABC.oss-cn-hangzhou.aliyuncs.com/2019/download4.png" alt=""></div>
    ...
    <div class="cover" id="cover" @click="coverClick"><img src="https://ABC.oss-cn-hangzhou.aliyuncs.com/2019/appdowncover.png"></img></div>
  </div>
</template>
  ...
  methods: {
    ...
    downloadClick(){
      if(this.isWeiXin()){
        ...
        location.href = "https://ABC.oss-cn-hangzhou.aliyuncs.com/appdownload/ABC-release.apk";
      }
    },
    coverClick(){
